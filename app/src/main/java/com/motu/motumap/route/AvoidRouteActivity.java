package com.motu.motumap.route;
...
import com.amap.map3d.demo.route.DriveRouteDetailActivity;
 ...
 * 驾车出行路线规划 实现
 */
public class AvoidRouteActivity extends Activity implements AMap.OnMapClickListener,
    ...
    private void registerListener() {
        aMap.setOnMapClickListener(AvoidRouteActivity.this);
        aMap.setOnMarkerClickListener(AvoidRouteActivity.this);
        aMap.setOnInfoWindowClickListener(AvoidRouteActivity.this);
        aMap.setInfoWindowAdapter(AvoidRouteActivity.this);
